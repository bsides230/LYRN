            ...
            while True:
                try:
                    ...
                    if message[0] == 'token':
                        ...
                        try:
                            # Overwrite temp file with just output as per requirement: "dumping the final response without the brackets into the temp chat file"
                            # The watcher will append this to the file that already contains the input.
                            with open(os.path.join(SCRIPT_DIR, "temp_chat_turn.txt"), 'w', encoding='utf-8') as f:
                                f.write(message[1])
